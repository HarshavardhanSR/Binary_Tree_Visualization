...
<body>
  <div class="container">
    <h1 class="fw-light text-white me-0 mb"  id="header">Tree Vizualization</h1>
    <div class="row min-vh-100 justify-content-end align-items-end me-5" style="margin-top: calc(20px - 100px);">
      <div class="col-lg-5">
        <?php
        if (!empty($login_err)) {
        ...
        ?>
        <div class="form-wrap fw-light text-white m-0 ">
          <h1 class="fw-light text-white m-0">Log In</h1>
