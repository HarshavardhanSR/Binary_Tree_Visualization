...
<body>
  <div class="container">
    <h1 class="fw-light text-white m-0" id="header">Tree Vizualization</h1>
    <div class="line-container">
    </div>
    <div class="row min-vh-100 justify-content-end align-items-end me-5"  style="margin-top: calc(20px - 70px);">
      <div class="col-lg-5">
        <div class="form-wrap text-white m-0">
          <h1>Sign up</h1>
